            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="card p-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="text-gray-500 text-sm font-medium">Всего принято</div>
                ...
                <div className="card p-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="text-gray-500 text-sm font-medium">Всего сдано</div>
                            <div className="text-2xl font-bold text-gray-900 dark:text-white">
                    ...
                    <table className="w-full">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-sm font-medium text-gray-500">Кто сдал</th>
                                <th className="px-6 py-3 text-left text-sm font-medium text-gray-500">Примечание</th>
                            </tr>
                        </thead>
